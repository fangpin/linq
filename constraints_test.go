...
// import "github.com/fangpin/linq"

// type (
// 	testSigned[T linq.Signed]     struct{ f T }
// 	testUnsigned[T linq.Unsigned] struct{ f T }
// 	testInteger[T linq.Integer]   struct{ f T }
// 	testFloat[T linq.Float]       struct{ f T }
// 	testComplex[T linq.Complex]   struct{ f T }
// 	testOrdered[T linq.Ordered]   struct{ f T }
// )
// `)
...
// 		t.Fatal(err)
// 	}
// 	// This package is github.com/fangpin/linq, so the root of the x/exp
...
// 	// needed by the linq package (which should just be some version of
// 	// x/exp itself).
...
// 	// linq.Signed, and uint does not satisfy that constraint.
